...
Read [CLAUDE.md](CLAUDE.md) for full instructions on working with this repository.
...
1. Read [METHODOLOGY.md](METHODOLOGY.md) to understand the displacement model and factor weights
2. Check the bubble-up rule in [CLAUDE.md](CLAUDE.md)
3. Be skeptical of AI data >12 months old
