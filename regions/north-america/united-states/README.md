...
The US dominance thesis is not speculation—it is materialising in real-time:

### Stargate Project (Announced January 2025)
- **Total commitment**: $500 billion over 4 years
- **Initial funding**: $100 billion (SoftBank $19B, OpenAI $19B, Oracle $7B, MGX $7B)
- **Capacity target**: 10 GW by end 2025
- **Sites operational/announced**: 6 (Abilene TX flagship operational; TX, NM, OH, WI sites underway)
- **Employment**: 100,000+ jobs projected

This is the largest AI infrastructure project in history. No other nation has announced anything comparable.

### Investment Gap (2024 Data)
| Metric | US | China | Gap |
|--------|-----|-------|-----|
| Private AI investment | $109.1B | $9.3B | **12x** |
| Generative AI investment | $33.9B | ~$3B | **11x** |
| Notable AI models produced | 40 | 15 | **2.7x** |
...
Yet what matters for national economic outcomes is not average adoption but [frontier adoption](trends/frontier-dominance.md)—the productivity of the leading firms that compete globally. American technology companies are deploying AI at unprecedented scale; American data centres are expanding at rates that dwarf competitors; American capital is flowing into AI infrastructure at multiples of any other nation. The cultural wariness of middle America toward AI is economically irrelevant when the firms that generate American wealth are AI-native. The luddite tendencies of the median citizen are simply bypassed.
