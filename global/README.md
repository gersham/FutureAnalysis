...
Current known facts and metrics.
...
Suppositions and predictions based on data and trends.
...
| [View from 2035](analysis/view-from-2035.md) | Projected end-state of the transformation |
...
|--------|------------|-----------|
| [North America](../regions/north-america/README.md) | Divergent: US dominance, Canadian restructuring | US, Canada |
| [Europe](../regions/europe/README.md) | Regulatory burden, energy crisis, fracturing | UK, Germany, France, Poland, Ireland, Switzerland |
| [Asia-Pacific](../regions/asia-pacific/README.md) | Adoption advantage, varied outcomes | China, Japan, Singapore, Australia |

---

## Key Metrics Summary (December 2025)
...
| Metric | US | China | Gap |
|--------|-----|-------|-----|
| Private AI investment | $109.1B | $9.3B | **12x** |
| Generative AI investment | $33.9B | ~$3B | **11x** |
| Cumulative 2013-2024 | $470B | ~$50B | **9x** |
| Notable AI models (2024) | 40 | 15 | **2.7x** |

**Critical caveat (DeepSeek disruption)**: Despite 12x investment gap, Chinese models achieved near-parity on benchmarks by end 2024 (Stanford HAI: 0.3% gap on MMLU). DeepSeek-V3/R1 trained at 1/100th cost of US models. Investment may not equal capability.

### AI Adoption Reality (Dec 2025)

The adoption picture is more nuanced than simple percentages suggest:

| Metric | Rate | Source |
|--------|------|--------|
| Organizations using AI in any function | 88% | McKinsey Nov 2025 |
| "High performers" capturing real value | **6%** | McKinsey Nov 2025 |
| US businesses with meaningful AI use | 9.7% | US Census Aug 2025 |
| Chinese employees using AI at work | 93% | KPMG 2025 |

**Key insight**: 88% are experimenting; only 6% are transforming. The gap between experimentation and operational deployment determines who captures value.

### Humanoid Robotics (2025 Status)

| Metric | Status |
|--------|--------|
| Tesla Optimus Gen 3 | Unveiled Oct 2025; autonomous learning demonstrated |
| Tesla production reality | Target 5,000 by end 2025; actual "hundreds" (mid-2025) — **significant shortfall** |
| BYD | 1,500 in 2025; 20,000 target by 2026; on track |
| Unitree R1 | **$5,900 price point** (July 2025) — potential game-changer |
| Commercial deployment | Digit (GXO/Amazon), Figure AI (BMW) |
| Market projections 2035 | $6B–$180B (30x analyst variance) |

**Assessment**: Demonstrations impressive; Western production behind schedule. Chinese manufacturers may lead on deployment via price advantage.
